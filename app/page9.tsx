...
function Insights({
  ...
  // point, so "today so far" is compared against "that day, up to the
  // same time" rather than that day's full 24 hours.
  const nowMsIntoDay =
  ...
  // Last week same day, same time-of-day cutoff
  ...
  // Last 7 weeks same weekday average, same time-of-day cutoff
