...
function Insights({
  ...
  // colored by weekday so recurring patterns (e.g. weekend spikes)
  // are visible at a glance rather than needing to be inferred from
  // date labels alone.
  const WEEKDAY_BAR_COLORS = [
    "#f87171", // Sun
    "#fb923c", // Mon
    "#facc15", // Tue
    "#4ade80", // Wed
  ...
  return (
    <>
      ...
      {/* Standalone Revenue graph — placed independently rather than
          directly under the KPIs, since Orders for the Day now sits
          there instead. Each bar is colored by weekday so recurring
          patterns are visible without reading every date label. */}
      <div className="card">
